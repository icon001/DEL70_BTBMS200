...
type
  ...
  private
    ...
    Function InsertTB_HOLIDAY(aDate,aName,aState:string):Boolean;
    Function UpdateTB_HOLIDAY(aDate,aName,aState:string):Boolean;
...
//  bResult := DeleteTB_Holiday(FormatDateTime('yyyymmdd',dt_Date.Date));
  UpdateTB_HOLIDAY(FormatDateTime('yyyymmdd',dt_Date.Date),ed_Name.Text,'D');
...
begin
  ...
  begin
    InsertTB_HOLIDAY(FormatDateTime('yyyymmdd',dt_Date.Date),ed_Name.Text,'I');
  end else
  begin
    UpdateTB_HOLIDAY(FormatDateTime('yyyymmdd',dt_Date.Date),ed_Name.Text,'I');
  end;
  updateTB_ACCESSDEVICEHoSend('N');
  Load_Holiday(FormatDateTime('yyyyMM',Month.Date));
...
function TfmHoliday.InsertTB_HOLIDAY(aDate, aName,aState: string): Boolean;
var
  stSql : string;
begin
  stSql := 'Insert Into TB_HOLIDAY ';
  stSql := stSql + '(GROUP_CODE,HO_DAY,HO_DESC,HO_SEND,HO_STATE) ';
  stSql := stSql + ' VALUES( ';
...
function TfmHoliday.UpdateTB_HOLIDAY(aDate, aName,aState: string): Boolean;
var
  stSql : string;
begin
