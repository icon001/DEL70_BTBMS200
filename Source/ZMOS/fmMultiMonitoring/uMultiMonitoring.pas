...
type
  ...
  private
    ...
    aCompanyName,aJijumName,aDepertName,aEmID,aDoorID:string;List:TAdvStringGrid);
  ...
  public
    ...
    procedure ShowMessage(aMessage:string;aDaemonNo:integer);
...
begin
  ...
  ShowMessage(stReceiveData,strtoint(stDaemonGubun));
...
procedure TfmMultiMonitoring.InsertDOORList(aPermitCode,aPermit, aTime, aLocationName,
  aDoorName, aCardNo, aUserName, aCompanyName, aJijumName,aDepertName, aEmID,aDoorID: string;List:TAdvStringGrid);
var
  nCol: integer;
...
procedure TfmMultiMonitoring.ShowMessage(aMessage: string;aDaemonNo:integer);
var
  stReceiveData: string;
  stNodeNo,stECUID,stDoorNo,stReaderNo : string;
  aCommand : char;
