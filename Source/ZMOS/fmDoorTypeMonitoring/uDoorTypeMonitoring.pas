...
type
  ...
  private
    ...
    aCompanyName,aJijumName,aEmID,aDoorID:string;List:TAdvStringGrid);
...
begin
  ...
  self.FindSubForm('Main').FindCommand('DoorTypeMonitor').Params.Values['VALUE'] := 'FALSE';
  self.FindSubForm('Main').FindCommand('DoorTypeMonitor').Execute;
  DeviceCodeList.Free;
...
procedure TfmDoorTypeMonitoring.InsertDOORList(aPermitCode,aPermit, aTime, aLocationName,
  aDoorName, aCardNo, aUserName, aCompanyName, aJijumName, aEmID,aDoorID: string;List:TAdvStringGrid);
var
  nCol: integer;
...
begin
  ...
  begin
    ...
    Cells[IntDoorIndexArray[9],1] := aEmID; //사번
    Cells[IntDoorIndexArray[10],1] := aDoorID; //사번
  end;
...
begin
  ...
  begin
    L_bFirst := False;
    self.FindSubForm('Main').FindCommand('DoorTypeMonitor').Params.Values['VALUE'] := 'TRUE';
    self.FindSubForm('Main').FindCommand('DoorTypeMonitor').Execute;
