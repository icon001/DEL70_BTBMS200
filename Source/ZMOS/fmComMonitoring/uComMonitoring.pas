...
begin
  self.FindSubForm('Main').FindCommand('COMMONITOR').Params.Values['VALUE'] := 'FALSE';
  self.FindSubForm('Main').FindCommand('COMMONITOR').Execute;
  Action := caFree;
...
begin
  bClear := True;
  self.FindSubForm('Main').FindCommand('COMMONITOR').Params.Values['VALUE'] := 'TRUE';
  self.FindSubForm('Main').FindCommand('COMMONITOR').Execute;
  btn_startClick(Self)
