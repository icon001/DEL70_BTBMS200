...
uses
  ...
  ActnList,ADODB,AdWnPort, DB,ActiveX,uGroupCommonLib;
...
procedure TfmGroupMonitoring.InsertDOORList(aPermitCode, aPermit, aTime,
  aLocationName, aDoorName, aCardNo, aUserName, aCompanyName, aJijumName,
  aEmID, aDoorID: string; List: TAdvStringGrid);
var
  nCol: integer;
begin
  ...
  begin
    ...
    Cells[DoorIndexArray[9],1] := aEmID; //사번
    Cells[DoorIndexArray[10],1] := aDoorID; //출입문
