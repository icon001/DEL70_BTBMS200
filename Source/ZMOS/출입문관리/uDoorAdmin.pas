...
type
  ...
  private
    ...
    procedure GridInit;
    procedure DeviceLoad(aBuildingCode,aFloorCode,aAreaCode:string;cmb_Box:TComboBox;aType:string);
...
procedure TfmDoorAdmin.DeviceLoad(aBuildingCode,aFloorCode,aAreaCode:string;cmb_Box: TComboBox; aType: string);
var
  stSql : string;
  stDeviceName : string;
  stDeviceID : string;
...
function TfmDoorAdmin.InsertIntoTB_DOOR(aNodeNo, aEcuID, aDoorNo,
  ...
  aAreaCode,aRegState,aTotWidth,aTotHeight,aCurX,aCurY,aDoorGubunCode:string):Boolean;
var
  stSql :string;
  stFdmsID : string;
begin
...
begin
  ...
  stSql := stSql + ' a.DO_TOTWIDTH,a.DO_TOTHEIGHT,a.DO_CURX,a.DO_CURY,a.DO_GUBUN ';
...
begin
  ...
  DeviceLoad(stBuildingCode,stFloorCode,stAreaCode,cmb_DeviceCode,'Y');
  DeviceLoad(stBuildingCode,stFloorCode,stAreaCode,cmb_regDeviceCode,'N');
  LockTypeSet;
  GridInit;
  FormClear;
  FormNameSet;
...
function TfmDoorAdmin.UpdateTB_DOORInfo(aNodeNo, aEcuID, aDoorNo,
  ...
  aTotWidth, aTotHeight, aCurX, aCurY,aDoorGubunCode: string): Boolean;
var
  stSql :string;
begin
  stSql := 'Update TB_DOOR set ';
...
begin
  ...
  LoadAreaCode(stBuildingCode,stFloorCode,cmb_AreaCode1);
  if cmb_AreaCode1.itemindex > 0 then stAreaCode := AreaCodeList.Strings[cmb_AreaCode1.itemindex];
  DeviceLoad(stBuildingCode,stFloorCode,'',cmb_DeviceCode,'Y');
  DeviceLoad(stBuildingCode,stFloorCode,'',cmb_regDeviceCode,'N');
//  if cmb_AreaCode1.ItemIndex > 0 then stAreaCode := AreaCodeList.Strings[cmb_AreaCode1.itemIndex];;
  DoorSeach(stBuildingCode,stFloorCode,stAreaCode,
            '',sg_Door.TopRow);
