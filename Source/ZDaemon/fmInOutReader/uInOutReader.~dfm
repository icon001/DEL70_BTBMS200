inherited fmInOutReader: TfmInOutReader
  Left = 457
  Top = 183
  Width = 423
  Height = 448
  ...
  object GroupBox11: TGroupBox [1]
    ...
    object cmb_Device: TComboBox
      ...
      ItemHeight = 12
      TabOrder = 0
      OnChange = cmb_DeviceChange
    end
  end
  object sg_InOutReader: TAdvStringGrid [2]
    Left = 0
    Top = 97
    Width = 415
    Height = 317
    ...
    ScrollBars = ssBoth
    TabOrder = 2
    OnSelectCell = sg_InOutReaderSelectCell
