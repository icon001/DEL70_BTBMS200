...
type
  ...
  private
    ...
    Function CardReDownLoad(aNodeNo,aEcuID:string):Boolean;
  public
    { Public declarations }
...
begin
  ...
  stSql := 'Select b.AC_MCUIP,a.AC_NODENO,a.AC_ECUID,a.AC_COMPORT,a.AC_DEVICENAME ';
  stSql := stSql + ' from ';
  stSql := stSql + ' ( ';
  ...
  begin
    ...
    begin
      ...
      While Not Eof do
      begin
        if NETTYPE = 'RS232' then stMcuIP := 'COM' + FindField('AC_COMPORT').AsString
        else stMcuIP := FindField('AC_MCUIP').AsString;
        cells[0,nRow] := stMcuIP;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        //CardReDownLoad(copy(cells[4,DeviceLoop],1,3),copy(cells[4,DeviceLoop],4,2));
...
begin
  ...
  Try
    ...
    begin
      ...
      while Not Eof do
      begin
        cmb_Mcu.Items.Add(FillZeroNumber(FindField('AC_NODENO').AsInteger,3) + ':' + FindField('AC_DEVICENAME').AsString);
        Next;
      end;
    end;
...
function TfmFTPDownLoad.CardReDownLoad(aNodeNo, aEcuID: string):Boolean;
var
  stSql : string;
begin
