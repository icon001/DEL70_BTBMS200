...
type
  ...
  private
    ...
    Function InsertTB_ALARMSTATUSCODE(aAlarmStateCode,aAlarmStateName,aAlarmCheck,aAlarmGrade,aAlarmSound:string):Boolean;
    Function UpdateTB_ALARMSTATUSCODE(aAlarmStateCode,aAlarmStateName,aAlarmCheck,aAlarmGrade,aAlarmSound:string):Boolean;
...
begin
  ...
  begin
    ...
    Try
      ...
      end else chk_Alarm.Checked := False;
    Except
...
begin
  ...
  if UpperCase(State) = 'INSERT' then
    bResult := InsertTB_ALARMSTATUSCODE(ed_AlarmStateCode.Text,ed_AlarmStateName.Text,stEventCheck,cmb_AlarmGrade.Text,stAlarm)
  else if UpperCase(State) = 'UPDATE' then
    bResult := UpdateTB_ALARMSTATUSCODE(ed_AlarmStateCode.Text,ed_AlarmStateName.Text,stEventCheck,cmb_AlarmGrade.Text,stAlarm);
...
function TfmAlarmStateCode.InsertTB_ALARMSTATUSCODE(aAlarmStateCode,
  aAlarmStateName, aAlarmCheck, aAlarmGrade,aAlarmSound: string): Boolean;
var
  stSql : string;
begin
  result := False;
