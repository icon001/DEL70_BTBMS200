...
type
  ...
  private
    ...
    function DupCheckAlaram(aNodeNo,aEcuID,aArmArea:string):Boolean;
    function CheckTB_ARMAREA(aNodeNo,aEcuID,aArmArea:string):Boolean;
...
var
  fmArmAreaAdmin: TfmArmAreaAdmin;
  State : string;
...
procedure TfmArmAreaAdmin.GridInit;
var
  nCol : integer;
begin
  with sg_Alarm do
...
procedure TfmArmAreaAdmin.MCULoad(aList:TStringList;cmb_Box:TComboBox;aAll:Boolean=True);
var
  stSql : string;
  stDeviceName : string;
begin
...
procedure TfmArmAreaAdmin.FormCreate(Sender: TObject);
begin
...
procedure TfmArmAreaAdmin.FormClose(Sender: TObject;
...
procedure TfmArmAreaAdmin.AlarmSearch(aNodeNo,aEcuID,
...
//          cells[10,nRow] := FindField('AL_REMOTERINGCNT').AsString;
          ...
          cells[14,nRow] := FindField('AR_LOCATEUSE').AsString;
          cells[15,nRow] := FindField('AR_TOTWIDTH').AsString;
          cells[16,nRow] := FindField('AR_TOTHEIGHT').AsString;
          cells[17,nRow] := FindField('AR_CURX').AsString;
          cells[18,nRow] := FindField('AR_CURY').AsString;
...
procedure TfmArmAreaAdmin.FormClear;
begin
...
procedure TfmArmAreaAdmin.ButtonEnable(aState: string);
begin
...
procedure TfmArmAreaAdmin.FormEnable(aState: string);
begin
  if upperCase(aState) = 'INSERT'  then
  begin
    //Alarm Form Enable
...
procedure TfmArmAreaAdmin.FormShow(Sender: TObject);
begin
  pan_header.Caption := Caption;
  AlarmSearch('000','','');
end;

procedure TfmArmAreaAdmin.cmb_MCUCodeChange(Sender: TObject);
var
  stNodeNo : string;
begin
...
procedure TfmArmAreaAdmin.btn_CloseClick(Sender: TObject);
begin
  Close;
end;

procedure TfmArmAreaAdmin.sg_AlarmClick(Sender: TObject);
var
  stNodeNo : string;
  stECUID : string;
...
procedure TfmArmAreaAdmin.LoadsBuildingCode(cmb_Box: TComboBox);
var
  stSql : string;
  TempAdoQuery : TADOQuery;
begin
...
procedure TfmArmAreaAdmin.LoadsFloorCode(aBuildingCode: string;
  cmb_Box: TComboBox);
var
  stSql : string;
  TempAdoQuery : TADOQuery;
...
procedure TfmArmAreaAdmin.LoadsAreaCode(aBuildingCode,
...
procedure TfmArmAreaAdmin.btn_InsertClick(Sender: TObject);
var
  stNodeNo : string;
  stEcuID : string;
begin
...
function TfmArmAreaAdmin.GetAlarmNo: integer;
var
  stSql : string;
begin
{  result := 1;
...
procedure TfmArmAreaAdmin.cmb_sEcuListChange(Sender: TObject);
var
  stNodeNo : string;
  stEcuID : string;
...
procedure TfmArmAreaAdmin.cmb_sBuildingCodeChange(Sender: TObject);
var
...
procedure TfmArmAreaAdmin.cmb_sFloorCodeChange(Sender: TObject);
var
  stBuildingCode : string;
  stFloorCode : string;
begin
...
function TfmArmAreaAdmin.GetAlarmViewSeq: integer;
var
  stSql : string;
begin
  result := 0;
...
procedure TfmArmAreaAdmin.btn_UpdateClick(Sender: TObject);
var
  stEcuID : string;
begin
...
procedure TfmArmAreaAdmin.btn_CancelClick(Sender: TObject);
var
  stNodeNo : string;
  stEcuID : string;
begin
...
procedure TfmArmAreaAdmin.btn_SaveClick(Sender: TObject);
var
  stAlarmNo : string;
  stNodeNo : string;
  stEcuID : string;
...
begin
  ...
  begin
    ...
    if Not CheckTB_ARMAREA(stNodeNo,stEcuID,inttostr(se_ArmAreaNo.Value) ) then
    begin
      ...
      stSql := stSql + '''' + stEcuID + ''',';
      stSql := stSql + '''' + '0' + inttostr(se_ArmAreaNo.Value) + ''',';
...
procedure TfmArmAreaAdmin.btn_DeleteClick(Sender: TObject);
var
  stDeviceID : string;
  stNodeNo : string;
  stEcuID : string;
...
function TfmArmAreaAdmin.DeleteTB_ZoneDevice(aAlarmNo: string): Boolean;
var
  stSql : string;
begin
...
function TfmArmAreaAdmin.DeleteTB_ADMINALARMDEVICE(
...
function TfmArmAreaAdmin.DeleteTB_ALARMDEVICE(
  aAlarmNo: string): Boolean;
var
  stSql : string;
begin
...
function TfmArmAreaAdmin.DupCheckAlaram(aNodeNo,
  aEcuID,aArmArea: string): Boolean;
var
  stSql : string;
begin
  Result := False;
...
function TfmArmAreaAdmin.InsertTB_ALARMDEVICE(aNodeNo,
...
function TfmArmAreaAdmin.UpdateTB_ALARMDEVICE(aNodeNo,
  aEcuID, aAlarmName, aAlarmViewSeq, aOutDelay, aInDelay, aAlarmID,
  aMuxTelNo, aRingCnt, aBuildingCode, aFloorCode, aAreaCode, aLocationUse,
  aTotX, aTotY, aX, aY: string): Boolean;
var
...
function TfmArmAreaAdmin.CreateTB_ZONEDEVICE(
  aAlarmNo: string): Boolean;
var
  i : integer;
begin
...
function TfmArmAreaAdmin.InsertTB_ZONEDEVICE(aNodeNo,aEcuID,aAlamName,
...
procedure TfmArmAreaAdmin.btnAlarmPositionClick(Sender: TObject);
var
  stBuildingCode : string;
  stFloorCode : string;
  stAreaCode : string;
...
function TfmArmAreaAdmin.UpdateTB_ACCESSDEVICEACK(aNodeNo, aECUID,
...
procedure TfmArmAreaAdmin.SpinEdit_OutDelayChange(Sender: TObject);
begin
  chk_AlaramUpdate.Checked := True;
end;

procedure TfmArmAreaAdmin.SpinEdit_InDelayChange(Sender: TObject);
begin
  chk_AlaramUpdate.Checked := True;
end;

procedure TfmArmAreaAdmin.ed_AlarmIDChange(Sender: TObject);
begin
  chk_AlaramUpdate.Checked := True;
end;

procedure TfmArmAreaAdmin.ed_MuxTelNoChange(Sender: TObject);
begin
  chk_AlaramUpdate.Checked := True;
end;

function TfmArmAreaAdmin.UpdateTB_ALARMDEVICEInfo(aNodeNo, aEcuID,
...
procedure TfmArmAreaAdmin.cmb_sAreaCodeChange(Sender: TObject);
begin
  if cmb_sAreaCode.itemindex < 0 then
  begin
    cmb_sAreaCode.Text := '';
...
procedure TfmArmAreaAdmin.ed_regAlarmNameEnter(Sender: TObject);
var
  TIMC: HIMC;
...
procedure TfmArmAreaAdmin.EcuLoad(aNodeNo:string;aList:TStringList;cmb_Box: TComboBox; aAll: Boolean);
var
  stSql : string;
  stDeviceName : string;
begin
...
procedure TfmArmAreaAdmin.cmb_sMCUListChange(Sender: TObject);
var
  stNodeNo : string;
begin
  stNodeNo := sMCUIDList.Strings[cmb_sMCUList.itemIndex];
...
procedure TfmArmAreaAdmin.cmb_EcuChange(Sender: TObject);
var
  stNodeNo : string;
  stEcuID : string;
begin
...
function TfmArmAreaAdmin.GetMaxArmAreaNo(aNodeNo,aEcuID:string): integer;
var
  stSql : string;
begin
  result := 0;
  ...
  begin
    ...
    Except
      Exit;
    End;
    if Not IsDigit(FindField('AR_AREANO').AsString) then result := 1
    else result := FindField('AR_AREANO').AsInteger + 1;
  end;
end;

function TfmArmAreaAdmin.CheckTB_ARMAREA(aNodeNo, aEcuID,
  aArmArea: string): Boolean;
var
  stSql : string;
begin
  Result := False;
