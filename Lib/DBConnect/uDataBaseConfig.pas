...
begin
  ...
  stSql := CommonSql.InsertIntoTB_DOORGUBUN('001','구분1');
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_DOORGUBUN('002','구분2');
  DataModule1.ProcessExecSQL(stSql);
...
var
  stSql : string;
begin
  stSql := CommonSql.InsertIntoTB_PERMITCODE('3','방범경계승인');
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_PERMITCODE('4','방범해제승인');
  DataModule1.ProcessExecSQL(stSql);
...
var
  stSql : string;
begin
  stSql := CommonSql.InsertIntoTB_ALARMDEVICETYPECODE('EL','감지기확장기');
  DataModule1.ProcessExecSQL(stSql);
...
var
  stSql : string;
begin
  stSql := CommonSql.InsertIntoTB_CONFIG('CARD','MAXCOUNT','1000','카드최대갯수');
  DataModule1.ProcessExecSQL(stSql);
...
var
  stSql : string;
begin
  stSql := CommonSql.InsertIntoTB_PERMITCODE('H','폐쇄모드출입불가');
  DataModule1.ProcessExecSQL(stSql);
...
begin
  ...
  stSql := CommonSql.InsertIntoTB_ALARMGUBUNCODE('001','구분1');
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_ALARMGUBUNCODE('002','구분2');
  DataModule1.ProcessExecSQL(stSql);
...
//  DataModule1.ProcessExecSQL(stSql);
  ...
  DataModule1.ProcessExecSQL(stSql);
  //침입
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','ZP','11','E130');  //오픈
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','ZS','11','E130');  //쇼트
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','ZP','11','E130');  //오픈
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','ZS','11','E130');  //쇼트
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','FI','11','E130');  //화재
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','E1','11','E130');  //비상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','G1','11','E130');  //가스
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','Q1','11','E130');  //설비
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','FI','11','E130');  //화재
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','E1','11','E130');  //비상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','G1','11','E130');  //가스
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','Q1','11','E130');  //설비
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','ZP','11','E130');  //오픈
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','ZS','11','E130');  //쇼트
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','ZP','11','E130');  //오픈
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','ZS','11','E130');  //쇼트
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','FI','11','E130');  //화재
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','E1','11','E130');  //비상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','G1','11','E130');  //가스
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','Q1','11','E130');  //설비
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','FI','11','E130');  //화재
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','E1','11','E130');  //비상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','G1','11','E130');  //가스
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','Q1','11','E130');  //설비
  DataModule1.ProcessExecSQL(stSql);
  //침입복구
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','ZN','11','R130');  //정상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','ZN','11','R130');  //정상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','F2','11','R130');  //화재
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','E2','11','R130');  //비상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','G2','11','R130');  //가스
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','A','Q2','11','R130');  //설비
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','F2','11','R130');  //화재
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','E2','11','R130');  //비상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','G2','11','R130');  //가스
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('MN','D','Q2','11','R130');  //설비
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','ZN','11','R130');  //정상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','ZN','11','R130');  //정상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','F2','11','R130');  //화재
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','E2','11','R130');  //비상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','G2','11','R130');  //가스
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','A','Q2','11','R130');  //설비
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','F2','11','R130');  //화재
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','E2','11','R130');  //비상
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','G2','11','R130');  //가스
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_KTTMAPPINGCODE('EX','D','Q2','11','R130');  //설비
  DataModule1.ProcessExecSQL(stSql);
...
begin
  ...
  stSql := CommonSql.InsertIntoTB_WORKGUBUN_Value('1','1','재직');
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_WORKGUBUN_Value('2','2','휴직');
  DataModule1.ProcessExecSQL(stSql);
  stSql := CommonSql.InsertIntoTB_WORKGUBUN_Value('3','3','퇴직');
  DataModule1.ProcessExecSQL(stSql);
