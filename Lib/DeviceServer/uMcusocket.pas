...
procedure TECUInfo.CD_Download(aCardNo, ValidDay: String; cardType,
  RegCode, aTimeCode, func: Char; aQuick:Boolean = False;aPositionNum:integer = 0;
  aCardPosition:Boolean = False;aAlarmAreaGrade:string = '';aDoorAreaGrade:string = '');
var
  aData: String;
  I: Integer;
  xCardNo: String;
...
procedure TECUInfo.ChangeArmAreaMode(aArmAreaNo: integer;
  aMode: TWatchMode);
begin
  case aMode of
...
procedure TECUInfo.CheckDeviceVersion(aQuick: Boolean);
begin
