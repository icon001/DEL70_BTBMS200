...
function TFireBird.AlterTB_ACCESSDEVICE_CARDBYTE_Add: string;
var
  stSql : string;
begin
...
function TFireBird.AlterTB_ACCESSDEVICE_CARDTYPEChange: string;
var
  stSql : string;
begin
...
function TFireBird.AlterTB_ACCESSDEVICE_JAVARATYPEAdd: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_JAVARATYPE varchar(1)  DEFAULT ''0'' ';
  result := stSql;
...
function TFireBird.AlterTB_ALARMEVENTZoneCode_Change: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMEVENT ALTER AL_ZONECODE TYPE varchar(2) NOT NULL ';
  result := stSql;  

end;

function TFireBird.AlterTB_ALARMEVENT_INSERTTIME_ADD: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMEVENT ADD AL_INSERTTIME varchar(17) NULL ';
  result := stSql;
end;
...
function TFireBird.AlterTB_ALARMSTATUSCODEColor_Add: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMSTATUSCODE ADD AL_COLOR INTEGER  DEFAULT 255  ';
  result := stSql;

end;

function TFireBird.AlterTB_ALARMSTATUSCODEGubun_Add: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMSTATUSCODE ADD AL_GUBUN varchar(3)  ';
  result := stSql;

end;

function TFireBird.AlterTB_ATCODEATHOUTRANGE_Add: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ATCODE ADD AT_HOUTRANGE varchar(4)  DEFAULT ''0000'' ';
  result := stSql;

end;

function TFireBird.AlterTB_ATCODEATOUTRANGE_Add: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ATCODE ADD AT_OUTRANGE varchar(4)  DEFAULT ''0000'' ';
  result := stSql;
end;

function TFireBird.AlterTB_ATCODEATSOUTRANGE_Add: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ATCODE ADD AT_SOUTRANGE varchar(4)  DEFAULT ''0000'' ';
  result := stSql;
...
function TFireBird.AlterTB_ATWORKTYPETODAYTIME_Add: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ATWORKTYPE ADD AW_TODAYTIME varchar(4)  DEFAULT ''0000'' ';
  result := stSql;
...
function TFireBird.AlterTB_DEVICECARDNOALARM_Add(aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNO ADD DE_ALARM' + inttostr(aNo) + '  varchar(1) DEFAULT ''N''  ';
  result := stSql;

end;

function TFireBird.AlterTB_DEVICECARDNODOOR_Add(aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNO ADD DE_DOOR' + inttostr(aNo) + '  varchar(1) DEFAULT ''N''  ';
  result := stSql;

end;

function TFireBird.AlterTB_DEVICECARDNOGROUPALARM_Add(
  aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNOGROUP ADD DE_ALARM' + inttostr(aNo) + '  varchar(1) DEFAULT ''N''  ';
  result := stSql;

end;

function TFireBird.AlterTB_DEVICECARDNOGROUPDOOR_Add(aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNOGROUP ADD DE_DOOR' + inttostr(aNo) + '  varchar(1) DEFAULT ''N''  ';
  result := stSql;
...
function TFireBird.AlterTB_EMPLOYEEWORKCODE_Add: string;
var
  stSql : string;
begin
...
function TFireBird.CreateTB_ARMAREA: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' AR_USE varchar(1) DEFAULT ''N'',';
  ...
  stSql := stSql + ' LO_DONGCODE varchar(3) DEFAULT ''000'' ,';
  stSql := stSql + ' LO_FLOORCODE varchar(3) DEFAULT ''000'' ,';
  stSql := stSql + ' LO_AREACODE varchar(3) DEFAULT ''000'' ,';
  stSql := stSql + ' AR_UPDATE varchar(1) DEFAULT ''N'',';
...
function TFireBird.CreateTB_ATLISTEVENT: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' CA_CARDNO varchar(10) ,';
  stSql := stSql + ' DO_DOORNO char(1) ,';
  stSql := stSql + ' AC_READERNO char(1) ,';
  stSql := stSql + ' AC_BUTTONNO char(1) ,';
  stSql := stSql + ' AT_DATE varchar(8) ,'; //근태날짜
...
function TFireBird.CreateTB_CARDFINGER: string;
var
  stSql : string;
begin
  stSql := 'Create Table TB_CARDFINGER (';
  stSql := stSql + ' FP_USERID integer NOT NULL,';
  stSql := stSql + ' FP_CARDNO varchar(20) NULL,';
  stSql := stSql + ' FP_DATA text  NULL,';
  stSql := stSql + ' FP_PERMIT char(1) NULL,';
  stSql := stSql + ' FP_CHANGE char(1) NULL,';
...
function TFireBird.CreateTB_CLIENTSOCK: string;
var
  stSql : string;
begin
...
function TFireBird.CreateTB_FINGERDEVICE: string;
var
  stSql : string;
begin
  stSql := 'Create Table TB_FINGERDEVICE (';
  stSql := stSql + ' FD_DEVICEID integer NOT NULL,';
  stSql := stSql + ' FD_DEVICENAME varchar(100) NULL,';
  stSql := stSql + ' FD_DEVICEIP varchar(20) NULL,';
...
function TFireBird.CreateTB_FINGERDEVICECARD: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' FP_USERID integer NOT NULL,';
  stSql := stSql + ' FP_PERMIT char(1) NULL,';
  stSql := stSql + ' FP_SEND char(1) NULL,';
...
function TFireBird.CreateTB_FIREGROUP: string;
var
  stSql : string;
begin
...
function TFireBird.CreateTB_FIREGUBUN: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' FG_NAME varchar(30),';
...
function TFireBird.CreateTB_JAVARASCHEDULE: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' SchUse VARCHAR(1) DEFAULT ''0'',';
  ...
  stSql := stSql + ' SendState VARCHAR(1) DEFAULT ''N'',';
...
function TFireBird.CreateTB_WORKGUBUN: string;
var
  stSql : string;
begin
...
begin
  ...
  stSql := stSql + ' f.EM_CODE,f.EM_NAME,c.PE_PERMITNAME,  f.CO_COMPANYCODE,f.CO_JIJUMCODE,f.CO_DEPARTCODE,f.PO_POSICODE,k.CT_NAME ';
  stSql := stSql + ' From TB_ACCESSEVENT a ';
  if Not IsMaster then
  begin
    if BuildingGrade = 4 then
...
function TFireBird.SelectTB_ALARMEVENTFromALARMCatch(aDate:string=''): string;
var
  stSql : string;
begin
...
function TFireBird.SelectTB_ATLISTEVENTFromDayBase(aFromDate,
...
begin
  ...
  stsql := stSql + ' WHEN a.AT_ATTYPE = ''4'' then ''외출'' ';
  stsql := stSql + ' WHEN a.AT_ATTYPE = ''5'' then ''복귀'' ';
  stSql := stSql + ' ELSE '''' ';
  stSql := stSql + ' END as AT_ATTYPE,a.* ';
