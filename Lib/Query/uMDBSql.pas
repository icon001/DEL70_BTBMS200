...
type
  ...
  public
    ...
    Function selectTB_DOORJoinAdmin(aBuildingCode,aFloorCode,aAreaCode:string;aDoorView:Boolean=False;aNodeNo:string='000'):string;
    Function selectTB_DOORJoinGrade(aBuildingCode,aFloorCode,aAreaCode,aCardNo:string;aDoorView:Boolean=False):string;
...
{    Function CreateTB_ALARMGUBUNCODE : string;
    ...
    Function AlterTB_ALARMDEVICETelNo_Add : string;
    Function AlterTB_ALARMDEVICEUPDATE : string;
    Function AlterTB_ALARMEVENT_INSERTTIME_ADD : string;
    Function AlterTB_ALARMEVENTAlarmGRADE_Add : string;
    Function AlterTB_ALARMEVENTAlarmSound_Add : string;
    Function AlterTB_ALARMEVENTCardno_Add : string;
    Function AlterTB_ALARMEVENTCheckUser_Add : string;
    ...
    Function AlterTB_ALARMEVENTOperChange : string;
    Function AlterTB_ALARMEVENTSTATECODE2Add : string;
    Function AlterTB_ALARMEVENTZoneCode_Change : string;
    Function AlterTB_ALARMSTATUSCODEALARMSOUND : string;
    Function AlterTB_ALARMSTATUSCODECodeChange :string;
...
//    Function AlterTB_ALARMSTATUSCODEPrimaryDelete : string;
    ...
    Function AlterTB_DEVICECARDNODOOR_Add(aNo:integer):string;
    Function AlterTB_DEVICECARDNOALARM_Add(aNo:integer):string;
    Function AlterTB_DEVICECARDNOGROUPDOOR_Add(aNo:integer):string;
    Function AlterTB_DEVICECARDNOGROUPALARM_Add(aNo:integer):string;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_ARMRING integer DEFAULT 10 NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_DAEMONGUBUN integer DEFAULT 1 NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_DEVICETYPE text(1) DEFAULT ''0'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_DISARMRING integer DEFAULT 10 NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_DOOR1TYPE text(1) DEFAULT ''2'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_DOOR2TYPE text(1) DEFAULT ''2'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD HO_SEND text(1) DEFAULT ''N'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_INDELAY integer DEFAULT 10 NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_JAEJUNG text(1) DEFAULT ''N'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_OUTDELAY integer DEFAULT 10 NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_POWERTYPE text(1) DEFAULT ''0'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_READERTYPE text(1) DEFAULT ''0'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSEVENT ADD CO_COMPANYCODE text(3) DEFAULT ''000'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSEVENT ADD CO_DEPARTCODE text(3) DEFAULT ''000'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ADMIN ADD LO_AREACODE text(3) DEFAULT ''000'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ADMIN ADD AD_BUILDINGGRADE text(1) DEFAULT ''4'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ADMIN ADD LO_DONGCODE text(3) DEFAULT ''000'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ADMIN ADD LO_FLOORCODE text(3) DEFAULT ''000'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_CARD ADD CA_DOORGRADE text(1) DEFAULT ''N'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_COMPANY ADD CO_UPDATECHECK text(1) DEFAULT ''N'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DOOR ADD DO_GUBUN text(3) DEFAULT ''000'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_FTPLIST ADD FL_RETRYCOUNT INTEGER DEFAULT 0 NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_HOLIDAY ADD HO_STATE text(1) DEFAULT ''I'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_KTCARDISSUE ADD KI_WRITE text(1) DEFAULT ''N'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_POSI ADD PO_UPDATECHECK text(1) DEFAULT ''N'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_READER ADD BUILD_POSI text(1) DEFAULT ''0'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_READER ADD DOOR_POSI text(1) DEFAULT ''0'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ZONEDEVICE ADD AL_DELAYUSE text(1) DEFAULT ''0'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ZONEDEVICE ADD AL_PORTRECOVERY text(1) DEFAULT ''0'' NOT NULL ';
  result := stSql;
...
begin
  ...
  stSql := stSql + ' WHERE AL_DATE BETWEEN ''' + aFromDate + ''' AND ''' + aToDate + ''' ';
  if Trim(aAlarmType) <> '' then
  begin
    stSql := stSql + ' AND ( AL_ALARMSTATUSCODE = ''' + aAlarmType + ''' ' ;
  ...
  stSql := stSql + ' ON (a.AL_STATUSCODE2 = d.AL_ALARMSTATUSCODE) ';
//  stSql := stSql + ' OR (a.AL_ALARMSTATUSCODE = d.AL_ALARMSTATUSCODE) ';
  stSql := stSql + ' AND (a.GROUP_CODE = d.GROUP_CODE) ';
  stSql := stSql + ' ) ';
  stSql := stSql + ' Left Join TB_ACCESSDEVICE e ';
  stSql := stSql + ' ON( a.GROUP_CODE = e.GROUP_CODE ';
...
begin
  ...
  stSql := stSql + ' (select * from TB_ACCESSEVENT IN ''';
  stSql := stSql + ExeFolder + '\..\DB\ZEVENT.mdb'' ';
  stSql := stSql + ' where AC_DATE BETWEEN ''' + aFromDate + ''' AND ''' + aToDate + ''') a ';
  if Not IsMaster then
  begin
    if BuildingGrade = 4 then
    begin
...
begin
  ...
  stSql := stSql + ' i.CO_NAME as CO_DEPARTNAME,j.PO_NAME,e.EM_CODE,f.EM_NAME,c.PE_PERMITNAME,k.CT_NAME ';
  stSql := stSql + ' FROM ';
  stSql := stSql + ' ( ';
  stSql := stSql + ' ( ';
  stSql := stSql + ' ( ';
...
var
  stSql : string;
begin
  stSql := 'Select a.*,b.positionnum,b.CA_CARDTYPE,c.em_retiredate ';
  stSql := stSql + ' from ';
  stSql := stSql + ' (';
...
begin
  stSql := ' select a.*,';
  stSql := stSql + 'b.positionnum,c.em_retiredate ';
  stSql := stSql + ' FROM  ';
  stSql := stSql + ' (  ';
  stSql := stSql + ' TB_DEVICECARDNO a';
  stSql := stSql + ' Left Join TB_CARD b';
...
function TMDBSql.selectTB_DOORJoinAdmin(aBuildingCode, aFloorCode,
  aAreaCode: string;aDoorView:Boolean=False;aNodeNo:string='000'): string;
var
  stSql : string;
begin
...
function TMDBSql.selectTB_DOORJoinGrade(aBuildingCode, aFloorCode,
  aAreaCode, aCardNo: string;aDoorView:Boolean=False): string;
var
  stSql :string;
begin
  ...
  stSql := stSql + '       (a.DO_DOORNO = ''2'' AND b.DE_DOOR2 = ''Y'') OR  ';
  stSql := stSql + '       (a.DO_DOORNO = ''3'' AND b.DE_DOOR3 = ''Y'') OR  ';
  stSql := stSql + '       (a.DO_DOORNO = ''4'' AND b.DE_DOOR4 = ''Y'') OR  ';
  stSql := stSql + '       (a.DO_DOORNO = ''5'' AND b.DE_DOOR5 = ''Y'') OR  ';
  stSql := stSql + '       (a.DO_DOORNO = ''6'' AND b.DE_DOOR6 = ''Y'') OR  ';
  stSql := stSql + '       (a.DO_DOORNO = ''7'' AND b.DE_DOOR7 = ''Y'') OR  ';
  stSql := stSql + '       (a.DO_DOORNO = ''8'' AND b.DE_DOOR8 = ''Y'') ) ';
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMDEVICE ADD AG_ARMCODE text(3) DEFAULT ''000'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMEVENT ADD AL_KTTSENDSTATUS text(1) DEFAULT ''N'' NOT NULL ';
  result := stSql;
end;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_MUXID text(2) DEFAULT ''00'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_DECODERID text(10) DEFAULT ''KTT00'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNO ADD downseq integer DEFAULT 0 NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_KTTMAPPINGCODE ADD SendUse text(1) DEFAULT ''Y'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ATCODE ADD AW_CODE text(3)  DEFAULT ''001'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_EMPLOYEE ADD AW_CODE text(3)  DEFAULT ''001'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMSTATUSCODE ADD AL_COLOR INTEGER  DEFAULT 255 NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ATWORKTYPE ADD AW_TODAYTIME text(4)  DEFAULT ''0000'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ATCODE ADD AT_OUTRANGE text(4)  DEFAULT ''0000'' NOT NULL ';
  result := stSql;
end;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ATCODE ADD AT_HOUTRANGE text(4)  DEFAULT ''0000'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ATCODE ADD AT_SOUTRANGE text(4)  DEFAULT ''0000'' NOT NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_JAVARATYPE text(1) NULL ';
  result := stSql;
end;
...
begin
  ...
  stSql := stSql + ' SchUse text(1) DEFAULT ''0'' NOT NULL,';
  ...
  stSql := stSql + ' SendState text(1) DEFAULT ''N'' NOT NULL,';
...
function TMDBSql.AlterTB_ALARMEVENTZoneCode_Change: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMEVENT ALTER COLUMN AL_ZONECODE text(2) NOT NULL ';
  result := stSql;  
end;

function TMDBSql.AlterTB_DEVICECARDNODOOR_Add(aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNO ADD DE_DOOR' + inttostr(aNo) + ' text(1) ';
  result := stSql;

end;

function TMDBSql.AlterTB_DEVICECARDNOALARM_Add(aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNO ADD DE_ALARM' + inttostr(aNo) + ' text(1) NULL ';
  result := stSql;

end;

function TMDBSql.AlterTB_DEVICECARDNOGROUPALARM_Add(aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNOGROUP ADD DE_ALARM' + inttostr(aNo) + ' text(1) NULL ';
  result := stSql;

end;

function TMDBSql.AlterTB_DEVICECARDNOGROUPDOOR_Add(aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNOGROUP ADD DE_DOOR' + inttostr(aNo) + ' text(1) NULL ';
  result := stSql;
...
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ACCESSDEVICE ADD AC_CARDBYTE integer DEFAULT 1 NOT NULL ';
  result := stSql;
...
function TMDBSql.AlterTB_ALARMEVENT_INSERTTIME_ADD: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMEVENT ADD AL_INSERTTIME text(17) NULL ';
  result := stSql;
