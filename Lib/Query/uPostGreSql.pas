...
function TPostGreSql.SelectTB_ALARMEVENTFromALARMCatch(aDate:string=''): string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ATWORKTYPETODAYTIME_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ATCODEATOUTRANGE_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ATCODEATHOUTRANGE_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ATCODEATSOUTRANGE_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_ATLISTEVENT: string;
var
  stSql : string;
begin
...
function TPostGreSql.SelectTB_ATLISTEVENTFromDayBase(aFromDate,
  aToDate: string): string;
var
  stSql : string;
begin
...
function TPostGreSql.SelectTB_EMPLOYEEJoinD2DDepartFoodState(aStarDate,
  aEndDate, aFoodArea, aFoodPermit: string): string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_CLIENTSOCK: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ACCESSDEVICE_JAVARATYPEAdd: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_JAVARASCHEDULE: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ACCESSDEVICE_CARDTYPEChange: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_ARMAREA: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ALARMEVENTZoneCode_Change: string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_ALARMEVENT ALTER COLUMN AL_ZONECODE TYPE varchar(2) NOT NULL ';
  result := stSql;

end;

function TPostGreSql.AlterTB_DEVICECARDNODOOR_Add(aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNO ADD DE_DOOR' + inttostr(aNo) + '  varchar(1) DEFAULT ''N''  NULL ';
  result := stSql;
end;

function TPostGreSql.AlterTB_DEVICECARDNOALARM_Add(aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNO ADD DE_ALARM' + inttostr(aNo) + '  varchar(1) DEFAULT ''N''  NULL ';
  result := stSql;

end;

function TPostGreSql.AlterTB_DEVICECARDNOGROUPALARM_Add(
  aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNOGROUP ADD DE_ALARM' + inttostr(aNo) + '  varchar(1) DEFAULT ''N''  NULL ';
  result := stSql;

end;

function TPostGreSql.AlterTB_DEVICECARDNOGROUPDOOR_Add(
  aNo: integer): string;
var
  stSql : string;
begin
  stSql := 'ALTER TABLE TB_DEVICECARDNOGROUP ADD DE_DOOR' + inttostr(aNo) + '  varchar(1) DEFAULT ''N''  NULL ';
  result := stSql;

end;

function TPostGreSql.AlterTB_ACCESSDEVICE_CARDBYTE_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_WORKGUBUN: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_EMPLOYEEWORKCODE_Add: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_CARDFINGER: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_FINGERDEVICE: string;
var
  stSql : string;
begin
...
function TPostGreSql.CreateTB_FINGERDEVICECARD: string;
var
  stSql : string;
begin
...
function TPostGreSql.AlterTB_ALARMEVENT_INSERTTIME_ADD: string;
var
  stSql : string;
begin
