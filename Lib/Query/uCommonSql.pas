...
type
  ...
  public
    ...
    Function InsertIntoTB_ALARMDEVICETYPECODE(aCode,aValue:string):string;
    Function InsertIntoTB_ALARMGUBUNCODE(aCode,aName:string):string;
    ...
    Function InsertIntoTB_DOORGUBUN(aCode,aName:string):string;
    ...
    Function InsertIntoTB_KTTMAPPINGCODE(aDeviceType,aAlarmMode,aStatusCode,aFuncode,aEventCode:string):string;
    ...
    Function InsertIntoTB_PERMITCODE(aPermitCode,aValue:string):string;
    ...
    Function UpdateTB_ALARMSTATUSCODE_Sound(aAL_ALARMSTATUSCODE,aAL_ALARMSOUND:string):string;
...
function TCommonSql.InsertIntoTB_DOORGUBUN(aCode, aName: string): string;
var
  stSql : string;
begin
...
function TCommonSql.InsertIntoTB_ALARMGUBUNCODE(aCode, aName: string): string;
var
  stSql : string;
begin
...
function TCommonSql.InsertIntoTB_KTTMAPPINGCODE(aDeviceType, aAlarmMode,
...
function TCommonSql.InsertIntoTB_PERMITCODE(aPermitCode,
  aValue: string): string;
var
  stSql : string;
begin
...
function TCommonSql.InsertIntoTB_ALARMDEVICETYPECODE(aCode,
  aValue: string): string;
var
  stSql : string;
begin
...
function TCommonSql.UpdateTB_ALARMSTATUSCODE_Sound(aAL_ALARMSTATUSCODE,
  aAL_ALARMSOUND: string): string;
var
  stSql : string;
begin
  stSql := 'Update TB_ALARMSTATUSCODE set AL_ALARMSOUND = ' + aAL_ALARMSOUND + ' ';
  stSql := stSql + ' where GROUP_CODE = ''' + GROUPCODE + ''' ';
  stSql := stSql + ' And AL_ALARMSTATUSCODE = ''' + aAL_ALARMSTATUSCODE + '''';
