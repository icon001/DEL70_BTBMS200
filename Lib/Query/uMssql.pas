...
function TMssql.SelectTB_ALARMGRADEJoinBase(aBuildingCode,aFloorCode,aAreaCode,aCardNo:string): string;
var
  stSql : string;
begin
...
function TMssql.SelectTB_EMPLOYEEATJoinATBasePAY: string;
var
  stSql : string;
begin
...
function TMssql.AlterTB_EMPLOYEEEmNameChange: string;
var
  stSql : string;
begin
  stSql := 'alter table TB_EMPLOYEE alter column  EM_NAME varchar(50) ';
  result := stSql;
...
function TMssql.SelectTB_ACCESSEVENTFromDayToTime(aFromDate, aStartTime,
...
function TMssql.AlterTB_ALARMEVENTZoneCode_Change: string;
var
  stSql : string;
begin
...
function TMssql.AlterTB_DEVICECARDNODOOR_Add(aNo: integer): string;
var
  stSql : string;
begin
...
function TMssql.AlterTB_DEVICECARDNOALARM_Add(aNo: integer): string;
var
  stSql : string;
begin
...
function TMssql.AlterTB_DEVICECARDNOGROUPALARM_Add(aNo: integer): string;
var
  stSql : string;
begin
...
function TMssql.AlterTB_DEVICECARDNOGROUPDOOR_Add(aNo: integer): string;
var
  stSql : string;
begin
...
function TMssql.AlterTB_ACCESSDEVICE_CARDBYTE_Add: string;
var
  stSql : string;
begin
...
function TMssql.CreateTB_WORKGUBUN: string;
var
  stSql : string;
begin
...
function TMssql.AlterTB_EMPLOYEEWORKCODE_Add: string;
var
  stSql : string;
begin
...
function TMssql.CreateTB_CARDFINGER: string;
var
  stSql : string;
begin
  ...
  stSql := stSql + ' FP_DATA varchar(max)  NULL,';
...
function TMssql.CreateTB_FINGERDEVICE: string;
var
  stSql : string;
begin
...
function TMssql.CreateTB_FINGERDEVICECARD: string;
var
  stSql : string;
begin
...
function TMssql.AlterTB_ALARMEVENT_INSERTTIME_ADD: string;
var
  stSql : string;
begin
