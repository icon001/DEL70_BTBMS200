...
var
  stSql : string;
begin
  stSql := ' Select a.AC_DATE,a.AC_TIME,d.DO_DOORNONAME,  a.AC_READERNO,a.AC_DOORPOSI,a.CA_CARDNO,g.CO_NAME as CO_COMPANYNAME, ';
  stSql := stSql + ' h.CO_NAME as CO_JIJUMNAME, i.CO_NAME as CO_DEPARTNAME,j.PO_NAME,e.EM_CODE,f.EM_NAME,c.PE_PERMITNAME ';
  stSql := stSql + ' FROM ';
  stSql := stSql + ' ( ';
  stSql := stSql + ' ( ';
  stSql := stSql + ' ( ';
